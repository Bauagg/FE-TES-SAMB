...
const PenerimaanBarangHeader = () => {
    ...
    const createPenerimaanBarangHeader = () => {
        ...
        const data = {
            trx_in_no: trx_out_no,
            whs_idf: parseInt(whs_idf),
            trx_in_date: formattedDate,
            trx_in_supp_idf: parseInt(trx_out_supp_idf),
            trx_in_notes: trx_out_notes
        }

        axios.post(`${process.env.REACT_APP_API_URL}/api/transaksi-penerima-barang-header`, data)
            .then(() => {
                axios.get(`${process.env.REACT_APP_API_URL}/api/transaksi-penerima-barang-header`)
                    .then((result) => {
    ...
    const updatePenerimaanBarangHeader = () => {
        ...
        axios.put(`${process.env.REACT_APP_API_URL}/api/transaksi-penerima-barang-header/${idData}`, data)
            .then(() => {
                axios.get(`${process.env.REACT_APP_API_URL}/api/transaksi-penerima-barang-header`)
                    .then((result) => {
    ...
    return (
        <div className="mx-4">
            <h1 className="font-bold fon text-[30px] text-center mb-5">Penerimaan Barang Header</h1>
            <button onClick={() => setToggleCreate(true)} className="bg-blue-500 hover:bg-blue-600 text-white py-1 px-3 rounded">Create Penerimaan Barang Header</button>
            <div>
                    ...
                    <tbody>
                        {data.map((item, index) => (
                            <tr key={index} className="text-center">
                                ...
                                <td className="py-2 px-4 border-b">{item.trx_in_no}</td>
                ...
                <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded shadow-lg w-96">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-lg font-semibold">Create Penerimaan Barang Header</h2>
            ...
            {toggleUpdate && (
                <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded shadow-lg w-96">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-lg font-semibold">Update Penerimaan Barang Header</h2>
...
export default PenerimaanBarangHeader